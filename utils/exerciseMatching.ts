...
const EXERCISE_ALIASES: Record<string, string> = {
  ...
  'activation prep': 'Walking High Knees',
  'activation_prep': 'Walking High Knees',
  'dynamic mobility': 'Seated Forward Fold',
  'dynamic_mobility': 'Seated Forward Fold',
  'mobility reset': 'Cooldown Walk',
  'mobility_reset': 'Cooldown Walk',
  'easy breathing': 'Diaphragmatic Breathing',
  'easy_breathing': 'Diaphragmatic Breathing',
